...
export class ProductsService {
    ...
    addNewCapa(idPersona: any, idUsuario: any): any { 
        ...
        this._persona.insertCapa(capa).subscribe(
    ...
    updatePersona(update: any): any { 
        ...
        if (_personas !== null) {
            ...
            const index   = persona.items.findIndex(p => p.id === update.id); 
            if (index !== -1) {
    ...
    updateProject(idProjeto: string, update: any): any { 
        ...
        if (projectsGroup) { 
            ...
            for (let projectGroup of projectsGroup) {
                ...
                const projectIndex = projectGroup.project_list.findIndex(project => project.id === update.id_project_group);
                if (projectIndex !== -1) {
    
                    const campaignIndex = projectGroup.project_list[projectIndex].campanhas.findIndex(campaign => campaign.id === update.id);
        ...
        if (projectsGroup) {
            ...
            for (let projectGroup of projectsGroup) {
                for (let item of projectGroup.project_list) {
                    ...
                    const campanhaIndex = item.campanhas.findIndex(a => a.id === idProjeto);
            ...
            for (let projectGroup of projectsGroup) {
                for (let item of projectGroup.project_list) {
                    ...
                    if (campanhaIndex !== -1) { 
                        ...
                        const _type = item.campanhas[campanhaIndex].card[type].findIndex(a => a.id === itemId);
                        if (_type !== -1) {
            ...
            for (let projectGroup of projectsGroup) {
                for (let item of projectGroup.project_list) {
                    ...
                    if (campanhaIndex !== -1) { 
                        ...
                        const _type = item.campanhas[campanhaIndex].card[type].findIndex(a => a.id === id);
                        if (_type !== -1) {
        ...
        if (projectsGroup) {
            ...
            for (let projectGroup of projectsGroup) {
                for (let item of projectGroup.project_list) {
                    ...
                    const campanhaIndex = item.campanhas.findIndex(a => a.id === update.id_projeto);
                ...
                for (let projectGroup of projectsGroup) {
                    for (let item of projectGroup.project_list) {
                        ...
                        if (campanhaIndex !== -1) { 
                            ...
                            //atualiza o item de dentro do card
                            const _type = item.campanhas[campanhaIndex].card[type].findIndex(a => a.id === update.id);
                            if (_type !== -1) {
